...
namespace Coders_Space
{
    public partial class Profile : Form
    {
        ...
        // Add this method to get subscription details
        private string GetSubscriptionDetails(string userId)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (subValidMonth == -1)
                    {
                        subscriptionDetails = "Unlimited (-1)"; // Admin
                    }
                    else
                    {
                        ...
                        if (daysLeft >= 0)
                        {
                            subscriptionDetails = $"Premium_User ({daysLeft} days left)";
                        }
                        else
                        {
        ...
        private void LoadUserData(string email)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    // Get subscription details and update labelSub
